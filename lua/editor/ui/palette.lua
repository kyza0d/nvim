...
ky.ui = {
  notify = {
    ...
    border = {
      error = { bg = { bg = { from = 'Normal', alter = 0.25 } }, fg = palette.pale_red },
      warn = { bg = { bg = { from = 'Normal', alter = 0.25 } }, fg = palette.light_yellow },
      info = { bg = { bg = { from = 'Normal', alter = 0.25 } }, fg = palette.dark_blue },
      debug = { bg = { bg = { from = 'Normal', alter = 0.25 } }, fg = palette.dark_blue },
      trace = { bg = { bg = { from = 'Normal', alter = 0.25 } }, fg = palette.dark_blue },
    },
  },
  modes = {
    ['n'] = 'NORMAL',
...
function palette.setup()
  ...
  local mode_colors = {
    normal = is_light and palette.dark_purple or palette.pale_pink,
  ...
  hl.all({
    { [palette.hls.normal] = { fg = normal_fg, bg = { from = 'Normal' } } },
    ...
    { [palette.hls.neotree] = { fg = normal_fg, bg = { from = 'Normal', alter = is_light and 0.15 or -0.15 } } },
    { [palette.hls.neotree_icon] = { fg = is_light and palette.green or palette.dark_green, bg = { from = 'Normal', alter = is_light and 0.15 or -0.15 } } },
    { [palette.hls.terminal] = { fg = normal_fg, bg = { from = 'Normal', alter = is_light and 0.30 or -0.30 } } },
    { [palette.hls.terminal_icon] = { fg = is_light and palette.green or palette.dark_green, bg = { from = 'Normal', alter = is_light and 0.30 or -0.30 } } },
