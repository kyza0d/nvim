...
hl.plugin('Neovide', {
  theme = {
    ['*'] = {
      { Cursor = { bg = '#ff9ac1', reverse = false } },
      { iCursor = { bg = '#ff9ac1', reverse = false } },
      { lCursor = { bg = '#ff9ac1', reverse = false } },
      { vCursor = { bg = '#ff9ac1', reverse = false } },
      { tCursor = { bg = '#ff9ac1', reverse = false } },
...
vim.opt.guifont = 'Cartograph CF Light,Symbols Nerd Font:h10.4:w1.4'
